...
function setup(){
 ...
 function spawnBots() {
  if(World.frameCount % 100 === 0) {
    var bot = createSprite(1400, 600,10,40);
...
function spawnBots3() {
  if(World.frameCount % 60 === 0) {
    var bot = createSprite(1400,280,10,40);
    bot.addAnimation("bot", bot1_img);
    bot.velocityX = - (8 + 3*count/100);
 ...
 function spawnBots4() {
  if(World.frameCount % 40 === 0) {
    var bot = createSprite(1400,120,10,40);
    bot.addAnimation("bot", bot1_img);
    bot.velocityX = - (10 + 3*count/100);
